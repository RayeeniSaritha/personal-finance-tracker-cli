...
2026-09-02,Walmart Supermarket Groceries,-120.50"""
    ...
    def test_import_revolut_statement_format(self) -> None:
        revolut_text = """Account transactions from 5 July 2026 to 8 September 2026
...
18-Jul-2026 Payment from SARITHA RAYEENI €1.00"""
        ...
        res = self.service.import_bank_statement(revolut_text)
        self.assertEqual(res.imported_count, 8)
